...
@register_env("PushCubeTest-v1", max_episode_steps=50)
class PushCubeTestEnv(PushCubeEnv):
    ...
    def _load_scene(self, options: dict):
        ...
        ro_red_base_color = ro_material_config["red"]["base_color"]
        if ro_red_base_color is None:
            ro_red_base_color = np.array([194, 19, 22, 255]) / 255
        ro_white_base_color = ro_material_config["white"]["base_color"]
        if ro_white_base_color is None:
            ro_white_base_color = np.array([255, 255, 255, 255]) / 255
        ...
        self.goal_region = build_red_white_target(
            ...
            thickness=1e-5,
            name="goal_region",
            red_color=ro_red_base_color,
            white_color=ro_white_base_color,
