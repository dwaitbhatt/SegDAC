...
from segdac_dev.envs.maniskill3.tasks.pick_cube import PickCubeVisual
from segdac_dev.envs.maniskill3.visual_generalization.tasks.scene_building import build_cube


@register_env("PickCubeTest-v1", max_episode_steps=50)
class PickCubeTestEnv(PickCubeVisual):
